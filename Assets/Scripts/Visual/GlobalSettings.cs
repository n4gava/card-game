...
public class GlobalSettings: MonoBehaviour 
{
    ...
    public int MaxCardOnHand = 10;
    public int MaxCreaturesOnTable = 8;
    ...
    public bool CanControlThisPlayer(AreaPosition owner)
    {
        ...
        return Players[owner].PlayerArea.AllowedToControlThisPlayer && Players[owner].PlayerArea.ControlsON && PlayersTurn && NotDrawingAnyCards;
    }
